        ...
        <div class="row justify-content-between">
          ...
          >
            ...
            <div class="speciality-box sp-second-box">
              ...
              <div class="sp-box-text text-center">
                <h3><ICountUp :delay="0" :endVal="3" :options="options2" /></h3>
            ...
            <div class="speciality-box sp-third-box">
              ...
              <div class="sp-box-text text-center">
                <h3>
                  <ICountUp :delay="0" :endVal="1200" :options="options" />
                </h3>
            ...
            <div class="speciality-box sp-fourth-box">
              ...
              <div class="sp-box-text text-center">
                <h3>
                  <ICountUp :delay="0" :endVal="900" :options="options" />
                </h3>
          ...
          >
            <div class="section-heading w-100 mb-28 mt-0">
              ...
              <p>
                We have a group of very expert people in different sectors. e.g-
                Graphic Design, Web Design, Web Development, Digital Marketing,
                Social Media Marketing, E-mail Marketing etc.
              </p>
            </div>
